# qlearningAgents.py͏󠄂͏️͏󠄌͏󠄎͏︈͏︂͏︁
# ------------------͏󠄂͏️͏󠄌͏󠄎͏︈͏︂͏︁
...
class QLearningAgent(ReinforcementAgent):
    ...
    def computeActionFromQValues(self, state):
        ...
        bestActions = [action for action in legal if self.getQValue(state, action) == maxValue]
...
class ApproximateQAgent(PacmanQAgent):
    ...
    def final(self, state):
        ...
        # call the super-class final method͏󠄂͏️͏󠄌͏󠄎͏︈͏︂͏︁
        PacmanQAgent.final(self, state)

        # did we finish training?͏󠄂͏️͏󠄌͏󠄎͏︈͏︂͏︁
        if self.episodesSoFar == self.numTraining:
            # you might want to print your weights here for debugging͏󠄂͏️͏󠄌͏󠄎͏︈͏︂͏︁
            "*** YOUR CODE HERE ***"
            pass
